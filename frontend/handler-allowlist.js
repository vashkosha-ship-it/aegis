...
window.AEGIS_ALLOWED_HANDLERS = Object.freeze({
  click: [
    ...
    'rejectPendingUser', 'removeBookOffline', 'removeBookmark',
    'renderSettingsSecurityTab', 'replayOnboardingTour', 'requestEmailChangeUI',
    'resetARSchemeZoom', 'resetFilters', 'resetPomodoro',
    'restartOnboarding', 'restartOnboardingFromTraining', 'retakeQuiz',
    'runBiometricUnlock', 'runFullTextSearch', 'saveBookOffline',
    'saveBooksGoalFromUI', 'saveProfileEdits', 'saveSettingsInfo',
    'saveSettingsPassword', 'selectBooksGoalCount', 'selectBooksGoalPeriod',
    'selectKillChainStage', 'selectLevelSelf', 'selectOnboardingAnswer',
    'sendAIMessage', 'sendAssistantMessage', 'setAppTheme',
    'setBooksGoal', 'setFinishReviewStar', 'setGridSize',
    'setHomeBooksTab', 'setKillChainViewMode', 'setPrivacyVisibility',
    'setReaderFontScale', 'setReadingGoal', 'setReviewStar',
    'showAnnotationDetail', 'showHeatmapDayDetails', 'showMyStatsModal',
    ...
    'toggleAIPanel', 'toggleBiometricFromSettings', 'toggleBookInCollection',
    'toggleCatalogPanel', 'toggleCategoryFilter', 'togglePageBookmark',
