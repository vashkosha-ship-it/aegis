...
window.AEGIS_ALLOWED_HANDLERS = Object.freeze({
  click: [
    ...
    'openAdminBookModal', 'openBookDetail', 'openBookFromAR',
    'openBookmarksList', 'openCertificationModal', 'openChatHistory',
    'openCyberLevelModal', 'openForgotPassword', 'openReader',
    'openReviewMode', 'openSettingsTab', 'openShortcutsModal',
    'openTOC', 'pausePomodoro', 'prevKillChainStage',
    'prevOnboardingQuestion', 'prevQuestion', 'rateCard',
    'readerSearchNext', 'readerSearchPrev', 'regenerateBookQuiz',
