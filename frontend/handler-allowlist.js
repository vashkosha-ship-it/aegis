...
window.AEGIS_ALLOWED_HANDLERS = Object.freeze({
  click: [
    ...
    'explainSelectionTerm', 'exportNotes', 'finishOnboarding',
    'finishOnboardingNav', 'finishQuiz', 'goToBooksPage',
    ...
    'readerSearchPrev', 'removeBookOffline', 'resetARSchemeZoom',
    'resetFilters', 'resetPomodoro', 'restartOnboarding',
    'restartOnboardingFromTraining', 'retakeQuiz', 'runFullTextSearch',
    'saveBookOffline', 'saveProfileEdits', 'selectKillChainStage',
    'sendAIMessage', 'sendAssistantMessage', 'setHomeBooksTab',
    'setKillChainViewMode', 'setReviewStar', 'showAnnotationDetail',
