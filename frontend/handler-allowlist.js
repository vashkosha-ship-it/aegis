...
window.AEGIS_ALLOWED_HANDLERS = Object.freeze({
  click: [
    ...
    'deleteAnnotation', 'deleteAnnotationFromTooltip', 'deleteComment',
    'deleteCurrentAvatar', 'deleteReview', 'doDeleteAccount',
    'doExportNotes', 'downloadCertificate', 'explainSelectionTerm',
    'exportAllUserData', 'exportNotes', 'finishOnboarding',
    'finishOnboardingNav', 'finishQuiz', 'flipFlashcard',
    'forgotPasswordReset', 'forgotPasswordSendCode', 'generateMissingCoversUI',
    'goToBooksPage', 'hideFromResume', 'highlightSelection',
    'jumpToBookmark', 'logout', 'lookupSelectionWord',
    ...
    'openAdminBookModal', 'openAdminLogs', 'openBookDetail',
