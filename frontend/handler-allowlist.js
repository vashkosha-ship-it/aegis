...
window.AEGIS_ALLOWED_HANDLERS = Object.freeze({
  click: [
    ...
    'closeShortcutsModal', 'confirmDeleteAccount', 'confirmEmailChangeUI',
    ...
    'finishQuiz', 'goToBooksPage', 'hideFromResume',
    ...
    'prevQuestion', 'readerSearchNext', 'readerSearchPrev',
    'removeBookOffline', 'renderSettingsSecurityTab', 'requestEmailChangeUI',
    ...
    'startBulkUpload', 'startNewChat', 'startPomodoro',
    'startQuizFromTraining', 'startReply', 'stopReindexPolling',
    'submitCertExam', 'submitComment', 'submitReview',
