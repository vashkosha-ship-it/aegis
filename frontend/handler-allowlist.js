...
window.AEGIS_ALLOWED_HANDLERS = Object.freeze({
  click: [
    ...
    'clearBulkUploadList', 'clearFullTextSearch', 'clickElement',
    ...
    'jumpToBookmark', 'loadChatFromHistory', 'logout',
    'lookupSelectionWord', 'markRequiredForDept', 'navigateTo',
    'nextKillChainStage', 'nextOnboardingQuestion', 'nextQuestion',
    'openARSchemeMenu', 'openARWithScheme', 'openAddModal',
    'openAddToCollection', 'openAdminBookModal', 'openAdminLogs',
    'openBookAnalyticsModal', 'openBookDetail', 'openBookFromAR',
