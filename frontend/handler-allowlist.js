...
window.AEGIS_ALLOWED_HANDLERS = Object.freeze({
  click: [
    ...
    'openAdminLogs', 'openBookDetail', 'openBookFromAR',
    'openBookmarksList', 'openBulkUploadModal', 'openCertificationModal',
    'openChatHistory', 'openCreateUserModal', 'openCyberLevelModal',
    'openExportModal', 'openForgotPassword', 'openPendingUsersModal',
    ...
    'regenerateBookQuiz', 'reindexAllBooksUI', 'removeBookOffline',
    ...
    'retakeQuiz', 'runFullTextSearch', 'saveBookOffline',
    ...
    'showAnnotationDetail', 'showMyStatsModal', 'showNoteTooltip',
