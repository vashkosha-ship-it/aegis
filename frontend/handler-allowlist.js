...
window.AEGIS_ALLOWED_HANDLERS = Object.freeze({
  click: [
    ...
    'deleteCurrentAvatar', 'deleteReview', 'downloadCertificate',
    ...
    'hideFromResume', 'highlightSelection', 'logout',
    ...
    'prevOnboardingQuestion', 'prevQuestion', 'readerSearchNext',
    'readerSearchPrev', 'removeBookOffline', 'renderSettingsSecurityTab',
    ...
    'setBooksGoal', 'setGridSize', 'setHomeBooksTab',
    ...
    'startPomodoro', 'startQuizFromTraining', 'startReply',
