...
window.AEGIS_ALLOWED_HANDLERS = Object.freeze({
  click: [
    ...
    'openAddModal', 'openBookDetail', 'openBookFromAR',
    ...
    'removeBookOffline', 'resetARSchemeZoom', 'resetFilters',
    'resetPomodoro', 'restartOnboardingFromTraining', 'retakeQuiz',
    'runFullTextSearch', 'saveProfileEdits', 'selectKillChainStage',
