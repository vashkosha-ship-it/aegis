...
window.AEGIS_ALLOWED_HANDLERS = Object.freeze({
  click: [
    ...
    'assistantCopy', 'assistantGotoQuiz', 'assistantPickBook',
    'assistantQuick', 'cancelReply', 'certNav',
    'clearAssistantChat', 'clearBulkUploadList', 'clickElement',
    'closeAIPanel', 'closeAR', 'closeARSchemeMenu',
    'closeAddModal', 'closeAdminBookModal', 'closeBookAnalyticsModal',
    'closeBulkUploadModal', 'closeCatalogPanel', 'closeCertModal',
    'closeEditProfileModal', 'closeFinishReviewModal', 'closeModal',
    'closeReader', 'closeReaderSearch', 'closeShortcutsModal',
    'confirmClearCache', 'confirmDeleteAccount', 'confirmEmailChangeUI',
    'convertToNote', 'createCollectionFromModal', 'deleteAdminUser',
    'deleteAnnotation', 'deleteAnnotationFromTooltip', 'deleteBook',
    'deleteComment', 'deleteCurrentAvatar', 'deleteReview',
    'deleteReviewAndRefresh', 'doDeleteAccount', 'doExportNotes',
    'downloadCertificate', 'explainSelectionTerm', 'exportAllUserData',
    'exportNotes', 'finishOnboarding', 'finishOnboardingNav',
    ...
    'logout', 'lookupSelectionWord', 'markRequiredForDept',
    'navigateTo', 'nextKillChainStage', 'nextOnboardingQuestion',
    'nextQuestion', 'openARSchemeMenu', 'openARWithScheme',
    'openAddModal', 'openAddToCollection', 'openAdminBookModal',
    'openAdminLogs', 'openBookAnalyticsModal', 'openBookDetail',
    'openBookFromAR', 'openBookmarksList', 'openBulkUploadModal',
    'openCertificationModal', 'openChatHistory', 'openCreateUserModal',
    'openCyberLevelModal', 'openExportModal', 'openForgotPassword',
    'openPendingUsersModal', 'openPrivacyPolicy', 'openReader',
    'openReviewMode', 'openSettingsTab', 'openShortcutsModal',
    'openTOC', 'openUserAgreement', 'pausePomodoro',
    'prevKillChainStage', 'prevOnboardingQuestion', 'prevQuestion',
    'rateCard', 'readerSearchNext', 'readerSearchPrev',
    'regenerateAllQuizzesUI', 'regenerateBookQuiz', 'reindexAllBooksUI',
    ...
    'saveBookOffline', 'saveBooksGoalFromUI', 'saveProfileEdits',
    'saveSettingsInfo', 'saveSettingsPassword', 'selectBooksGoalCount',
    'selectBooksGoalPeriod', 'selectKillChainStage', 'selectLevelSelf',
    'selectOnboardingAnswer', 'sendAIMessage', 'sendAssistantMessage',
    'setAppTheme', 'setBooksGoal', 'setFinishReviewStar',
    'setGridSize', 'setHomeBooksTab', 'setKillChainViewMode',
    'setPrivacyVisibility', 'setReaderFontScale', 'setReadingGoal',
    'setReviewStar', 'showAnnotationDetail', 'showMyStatsModal',
    'showNoteTooltip', 'skipOnboarding', 'startBulkUpload',
    'startNewChat', 'startOnboardingQuiz', 'startPomodoro',
    'startQuiz', 'startQuizFromTraining', 'startReply',
    'stopReindexPolling', 'submitCertExam', 'submitComment',
    'submitFinishReview', 'submitReview', 'summarizeCurrentChapter',
    'switchARCamera', 'switchKillChainTab', 'tocGoTo',
    'toggleAIPanel', 'toggleBookInCollection', 'toggleCatalogPanel',
    'togglePageBookmark', 'togglePasswordVisibility', 'togglePomodoro',
    'toggleReaderSearch', 'toggleReaderTheme', 'toggleStageDetailsPanel',
    'toggleTocRead', 'triggerInstall', 'zoomARScheme',
  ],
  change: [
