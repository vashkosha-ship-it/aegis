...
window.AEGIS_ALLOWED_HANDLERS = Object.freeze({
  click: [
    ...
    'closeFinishReviewModal', 'closeModal', 'closeReader',
    'closeReaderSearch', 'closeShortcutsModal', 'confirmClearCache',
    'confirmDeleteAccount', 'confirmEmailChangeUI', 'convertToNote',
    'createCollectionFromModal', 'deleteAnnotation', 'deleteAnnotationFromTooltip',
    ...
    'forgotPasswordReset', 'forgotPasswordSendCode', 'goToBooksPage',
    ...
    'openAddToCollection', 'openAdminBookModal', 'openBookDetail',
    'openBookFromAR', 'openBookmarksList', 'openCertificationModal',
    'openChatHistory', 'openCyberLevelModal', 'openForgotPassword',
    'openReader', 'openReviewMode', 'openSettingsTab',
    'openShortcutsModal', 'openTOC', 'pausePomodoro',
    'prevKillChainStage', 'prevOnboardingQuestion', 'prevQuestion',
    'rateCard', 'readerSearchNext', 'readerSearchPrev',
    'regenerateBookQuiz', 'removeBookOffline', 'removeBookmark',
