...
window.AEGIS_ALLOWED_HANDLERS = Object.freeze({
  click: [
    ...
    'resetFilters', 'resetPomodoro', 'restartOnboardingFromTraining',
    'retakeQuiz', 'runFullTextSearch', 'saveProfileEdits',
