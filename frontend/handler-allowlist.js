...
window.AEGIS_ALLOWED_HANDLERS = Object.freeze({
  click: [
    ...
    'convertToNote', 'createCollectionFromModal', 'deleteAnnotation',
    'deleteAnnotationFromTooltip', 'deleteComment', 'deleteCurrentAvatar',
    'deleteReview', 'doExportNotes', 'downloadCertificate',
    ...
    'highlightSelection', 'jumpToBookmark', 'logout',
    'lookupSelectionWord', 'navigateTo', 'nextKillChainStage',
    ...
    'openCertificationModal', 'openChatHistory', 'openCyberLevelModal',
    'openForgotPassword', 'openReader', 'openReviewMode',
    ...
    'reindexAllBooksUI', 'removeBookOffline', 'removeBookmark',
    'renderSettingsSecurityTab', 'requestEmailChangeUI', 'resetARSchemeZoom',
