...
window.AEGIS_ALLOWED_HANDLERS = Object.freeze({
  click: [
    ...
    'askAiAboutSnippet', 'assistantCopy', 'assistantGotoQuiz',
    'assistantPickBook', 'assistantQuick', 'cancelReply',
    'certNav', 'clearAssistantChat', 'clearBulkUploadList',
    'clearFullTextSearch', 'clickElement', 'closeAIPanel',
    ...
    'createCollectionFromModal', 'deleteAdminUser', 'deleteAnnotation',
    'deleteAnnotationFromTooltip', 'deleteBook', 'deleteComment',
