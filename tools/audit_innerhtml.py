...
FILES = [
    ...
    Path("frontend/ar-schemes-data.js"),
    Path("frontend/ar-schemes-renderers.js"),
    Path("frontend/ar-schemes-interactions.js"),
    Path("frontend/assistant-chat.js"),
    Path("frontend/admin-screens.js"),
    Path("frontend/admin-users.js"),
    Path("frontend/admin-ai-operations.js"),
    Path("frontend/admin-books.js"),
    Path("frontend/admin-bulk-upload.js"),
    Path("frontend/auth-ui.js"),
    Path("frontend/account-settings.js"),
    Path("frontend/account-privacy.js"),
    Path("frontend/account-personalization.js"),
    Path("frontend/account-profile.js"),
